document.getElementById("inputfile").addEventListener("change", function () {
  ...
  fr.onload = function () {
    ...
    var names = [];
    var isIphone = lines[0].indexOf("[") > -1 && lines[0].indexOf("]") > -1;
    if (isIphone) {
      lines.forEach((line) => {
      ...
      lines.forEach((line) => {
        var date = line.substring(0, line.indexOf("-")).trim();
        var username = line
          .substring(line.indexOf("- ") + 1, line.indexOf(": "))
          .trim();
        var message = line
        ...
        if (isIphone) {
          lines.forEach((line) => {
            ...
            if (username == selected_user && message != "") {
              ...
              small.innerHTML =
                date + '<i class="ml-1 fa fa-check-circle"></i>';
